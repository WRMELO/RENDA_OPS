...
| 78 | T-124-CADENCE-COHORT-DECISION-BR-V1 | Estudo decisorio 7x1 vs 10x2 vs 9x3: phase sweep cad 7/9/10 + agregacao de coortes + correcao de custo fixo por nota | D-191 | backtest/t124_cadence_cohort_decision_br/*, DECISION_LOG.md, ROADMAP.md, CHANGELOG.md | DONE |
...
| 80 | T-SDC-BR-CDI-CARRY-FALLBACK-5S-V1 | BCB SGS 404/Value(s) not found → vazio sem retry; carry CDI oficial ate 5 pregoes BVMF com WARN; veto no 6o; sem tag de motor | SALA D-229 | lib/adapters.py, pipeline/01_ingest_macro.py, tests/test_bcb_adapter_sgs_empty.py, tests/test_ingest_macro_cdi_carry.py, CHANGELOG.md, ROADMAP.md, DECISION_LOG.md | DONE |
