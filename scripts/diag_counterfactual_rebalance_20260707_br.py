"""Diagnostico contrafactual do rebalance BR em 2026-07-07.

Compara ranking M3 entre:
- canonical antigo (backup pre-fix)
- canonical novo (apos fix AZEV)
...
CANONICAL_OLD = ROOT / "data" / "ssot" / "canonical_br.parquet.bak_pre_azev_fix_20260715"
...
OUT_DIAG = ROOT / "data" / "diagnostics" / "counterfactual_rebalance_20260707_br.json"
TARGET_DATE = pd.Timestamp("2026-07-07")
...
def run() -> None:
    ...
    azev_flags = {
        "AZEV3_old_top10": "AZEV3" in old_top_n,
        "AZEV3_new_top10": "AZEV3" in new_top_n,
        "AZEV4_old_top10": "AZEV4" in old_top_n,
        "AZEV4_new_top10": "AZEV4" in new_top_n,
    }
    ...
    print("[DIAG] Contrafactual 2026-07-07 concluido.")
    print(f"[DIAG] old_top10: {old_top_n}")
    print(f"[DIAG] new_top10: {new_top_n}")
    print(f"[DIAG] AZEV flags: {azev_flags}")
