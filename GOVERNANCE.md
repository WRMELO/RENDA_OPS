...
**Arquivos protegidos** (auditados e selados em `v1.12.0-motor`):
...
3. A tag `v1.12.0-motor` marca o snapshot auditado atual. Para restaurar: `git checkout v1.12.0-motor`.
4. Novas versoes do motor devem gerar nova tag (`v1.12.0-motor`, etc.) apos novo ciclo completo de auditoria.
