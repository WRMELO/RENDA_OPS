...
**Arquivos protegidos** (auditados e selados em `v1.13.0-motor`):
...
3. A tag `v1.13.0-motor` marca o snapshot auditado atual. Para restaurar: `git checkout v1.13.0-motor`.
